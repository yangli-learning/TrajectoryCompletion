...
const char* vertex_shader_normal = {
  "varying vec3 normal;\n"
  "void main(void)\n"
  "{\n"
...
osg::Geode* drawCylinders(const osg::Vec3Array* bases, const osg::Vec3Array* tops, const std::vector<double>& radii,
                          const osg::Vec4Array* colors, int subdivide_level) {
  osg::Geode* geode = new osg::Geode();
  ...
  for (size_t i = 0, i_end = partition_num; i < i_end; ++ i) {
    ...
    cylinders_vertices->setBinding(osg::Array::BIND_PER_VERTEX);
    geometry->setNormalArray(cylinders_normals);
    cylinders_normals->setBinding(osg::Array::BIND_PER_VERTEX);
    geometry->setColorArray(cylinders_colors);
    cylinders_colors->setBinding(osg::Array::BIND_PER_VERTEX);
...
osg::Group* drawArrow(const osg::Vec3& base, const osg::Vec3& top, double radius, double head_length,
...
static void triangulateSphere(int subdivide_level, std::vector<int>& triangles, osg::Vec3Array* vertices,
...
osg::Geode* drawSpheres(const osg::Vec3Array* centers, double radius, const osg::Vec4Array* colors, int subdivide_level) {
  ...
  triangulateSphere(subdivide_level, triangles, vertices, normals);
  for (size_t i = 0, i_end = vertices->size(); i < i_end; i ++)
  ...
  for (size_t i = 0, i_end = partition_num; i < i_end; ++ i) {
    ...
    osg::ref_ptr<osg::DrawElementsUShort> sphere_triangles(new osg::DrawElementsUShort(GL_TRIANGLES,
        sphere_num*triangles.size()));
    ...
    spheres_vertices->setBinding(osg::Array::BIND_PER_VERTEX);
    geometry->setNormalArray(spheres_normals);
    spheres_normals->setBinding(osg::Array::BIND_PER_VERTEX);
    geometry->setColorArray(spheres_colors);
    spheres_colors->setBinding(osg::Array::BIND_PER_VERTEX);
...
osg::Geode* drawSpheres(const osg::Vec3Array* centers, const std::vector<double>& radii, const osg::Vec4Array* colors,
                        int subdivide_level) {
 osg::Geode* geode = new osg::Geode();
...
osg::Geode* drawPolygon(osg::Vec3Array* polygon, const osg::Vec4& color) {
  ...
  polygon->setBinding(osg::Array::BIND_PER_VERTEX);
  geometry->setColorArray(colors);
...
osg::Geode* drawLine(const osg::Vec3Array* pts, const osg::Vec4& color){
 ...
 osg::Vec3 offset = top-base;
  ...
  geometry->setUseDisplayList(true);
	...
	geometry->setVertexArray(const_cast<osg::Vec3Array*> (pts));
	osg::ref_ptr<osg::DrawArrays> da= new osg::DrawArrays(osg::PrimitiveSet::LINES,0,pts->size());
  ...
  colors->push_back(transparentColor);
	...
	osg::Geode* geode = new osg::Geode();
	geode->addDrawable(geometry);
	qDebug() << "draw line created " << geode->getNumDrawables() << " drawables";
	return geode;
}
...
osg::Geode* drawBBox(osg::BoundingBox* bbox, double thickness, const osg::Vec4& color) {
  ...
  edges.push_back(new osg::LineSegment(osg::Vec3(bbox->xMin(), bbox->yMin(), bbox->zMin()), osg::Vec3(bbox->xMax(),
                                       bbox->yMin(), bbox->zMin())));
  edges.push_back(new osg::LineSegment(osg::Vec3(bbox->xMin(), bbox->yMin(), bbox->zMin()), osg::Vec3(bbox->xMin(),
                                       bbox->yMax(), bbox->zMin())));
  edges.push_back(new osg::LineSegment(osg::Vec3(bbox->xMin(), bbox->yMin(), bbox->zMin()), osg::Vec3(bbox->xMin(),
                                       bbox->yMin(), bbox->zMax())));

  edges.push_back(new osg::LineSegment(osg::Vec3(bbox->xMin(), bbox->yMax(), bbox->zMax()), osg::Vec3(bbox->xMax(),
                                       bbox->yMax(), bbox->zMax())));
  edges.push_back(new osg::LineSegment(osg::Vec3(bbox->xMin(), bbox->yMax(), bbox->zMax()), osg::Vec3(bbox->xMin(),
                                       bbox->yMin(), bbox->zMax())));
  edges.push_back(new osg::LineSegment(osg::Vec3(bbox->xMin(), bbox->yMax(), bbox->zMax()), osg::Vec3(bbox->xMin(),
                                       bbox->yMax(), bbox->zMin())));

  edges.push_back(new osg::LineSegment(osg::Vec3(bbox->xMax(), bbox->yMax(), bbox->zMin()), osg::Vec3(bbox->xMin(),
                                       bbox->yMax(), bbox->zMin())));
  edges.push_back(new osg::LineSegment(osg::Vec3(bbox->xMax(), bbox->yMax(), bbox->zMin()), osg::Vec3(bbox->xMax(),
                                       bbox->yMin(), bbox->zMin())));
  edges.push_back(new osg::LineSegment(osg::Vec3(bbox->xMax(), bbox->yMax(), bbox->zMin()), osg::Vec3(bbox->xMax(),
                                       bbox->yMax(), bbox->zMax())));

  edges.push_back(new osg::LineSegment(osg::Vec3(bbox->xMax(), bbox->yMin(), bbox->zMax()), osg::Vec3(bbox->xMin(),
                                       bbox->yMin(), bbox->zMax())));
  edges.push_back(new osg::LineSegment(osg::Vec3(bbox->xMax(), bbox->yMin(), bbox->zMax()), osg::Vec3(bbox->xMax(),
                                       bbox->yMax(), bbox->zMax())));
  edges.push_back(new osg::LineSegment(osg::Vec3(bbox->xMax(), bbox->yMin(), bbox->zMax()), osg::Vec3(bbox->xMax(),
                                       bbox->yMin(), bbox->zMin())));
