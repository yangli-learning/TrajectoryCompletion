...
/* Infinite Distance */
const long INFINITE_DIST = 1000000000;
...
class DGraph
{
  public:
    ...
    /*
      DGraph::DGraph(int n);
      DGraph::~DGraph(); 
Note: need to add removeVertex 
    */
    
    void clear();
    void addNewEdge(int srcVertexNo, int destVertexNo, long dist);
	void removeEdge(int srcVertexNo, int destVertexNo);
    long int getEdgeWeight(int src, int dest);
